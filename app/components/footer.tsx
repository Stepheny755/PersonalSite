            ...
            <div className="w-full mx-auto max-w-screen-xl p-4 sm:px-6">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-between sm:mt-0">
                        <a href="/docs/resume.pdf" className="text-gray-600 dark:text-stone-200 hover:text-stone-900 dark:hover:text-white ms-5">

            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-5 lg:py-6">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="https://github.com/Stepheny755" className="text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white ms-5">
                        ...
                        <a href="https://www.linkedin.com/in/stepheny755/" className="text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white ms-5">
                        ...
                        <a href="https://www.researchgate.net/profile/Stephen_Yang8" className="text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white ms-5">
                        ...
                        <a href="https://scholar.google.ca/citations?user=_0xralQAAAAJ" className="text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white ms-5">

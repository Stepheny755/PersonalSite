      ...
      <div className="bg-l_body dark:bg-d_body">
        <div className="mx-auto w-full max-w-screen-xl px-2 lg:px-22 md:px-16 sm:px-10">
          <div className="container text-stone-800 dark:text-stone-100">
            ...
            <p className="my-4">
              Previously, I worked on FPGA IP Development at <a href="https://www.intel.com/content/www/us/en/products/programmable.html" className="underline font-bold">Intel</a>, and at the <a href="https://www.dsp.utoronto.ca/" className="underline font-bold">UofT Multimedia Lab</a> on ML for computational pathology. Read more on my <a href="/resume.pdf" className="underline font-bold">resume</a>.
            </p>
            <p className="my-4">
